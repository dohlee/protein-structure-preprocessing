# PDB parsing script adopted from
# https://github.com/KULL-Centre/papers/blob/main/2022/ML-ddG-Blaabjerg-et-al/src/pdb_parser_scripts/clean_pdb.py
...
def clean_pdb(pdb_input_filename: str, output: str):
    """
    Function to clean pdbs using reduce and pdbfixer.
    The output file will have "_cleaned.pdb" suffix.
